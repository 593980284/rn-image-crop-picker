package com.reactnative.ivpusic.imagepicker.cameralibrary;
...
import com.reactnative.ivpusic.imagepicker.cameralibrary.listener.CaptureListener;
...
import com.reactnative.ivpusic.imagepicker.cameralibrary.listener.TypeListener;
import com.reactnative.ivpusic.imagepicker.cameralibrary.state.CameraMachine;
...
import com.reactnative.ivpusic.imagepicker.cameralibrary.util.ScreenUtils;
import com.reactnative.ivpusic.imagepicker.cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.ic_camera_path);
    ...
    private void initView() {
        ...
        mCaptureLayout.setTypeLisenter(new TypeListener() {
            ...
            @Override
            public void edit() {
                String path = FileUtil.saveBitmap("JCamera", captureBitmap);
                Uri uri = Uri.fromFile(new File(path));
                File file = new File(getContext().getCacheDir(), Md5Utils.md5(path) + String.valueOf(System.currentTimeMillis()) + ".jpg");
                ...
                ((Activity) getContext()).startActivityForResult(intent, REQ_IMAGE_EDIT);
            }
        });
        //退出
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void showPicture(Bitmap bitmap, boolean isVertical) {
        ...
        mCaptureLayout.setIsPicture(true);
