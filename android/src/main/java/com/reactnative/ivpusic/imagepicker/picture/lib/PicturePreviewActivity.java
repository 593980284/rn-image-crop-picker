...
import com.reactnative.ivpusic.imagepicker.picture.lib.anim.OptAnimationLoader;
...
import com.reactnative.ivpusic.imagepicker.picture.lib.tools.VoiceUtils;
 ...
 * data：16/12/31
 */
public class PicturePreviewActivity extends PictureBaseActivity implements View.OnClickListener, Animation.AnimationListener, SimpleFragmentAdapter.OnCallBackActivity, SimpleFragmentAdapter.SimpleFragmentAdapterInterface {
    ...
    public static final int REQ_IMAGE_EDIT = 10001;
    ...
    private void initViewPageAdapterData() {
        tv_title.setText(position + 1 + "/" + images.size());
        adapter = new SimpleFragmentAdapter(images, this, this, this);
